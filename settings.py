...
class Settings():
    ...
    def readSettings(self):
        ...
        self.compassResolution = int(qset.value('/ShapeTools/CompassResolution', 0))
...
class SettingsWidget(QDialog, FORM_CLASS):
    ...
    def accept(self):
        ...
        settings.compassResolution = self.compassComboBox.currentIndex()
        qset.setValue('/ShapeTools/CompassResolution', settings.compassResolution)
    ...
    def showEvent(self, e):
        ...
        self.compassComboBox.setCurrentIndex(settings.compassResolution)
