...
PY_FILES = shapeTools.py __init__.py LatLon.py vector2Shape.py xyToLine.py settings.py geodesicDensify.py geodesicMeasureTool.py azDigitizer.py provider.py
EXTRAS = metadata.txt
