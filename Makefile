...
PY_FILES = shapeTools.py __init__.py LatLon.py vector2Shape.py xyToLine.py settings.py geodesicDensify.py geodesicMeasureTool.py azDigitizer.py provider.py createDonut.py createLob.py createPolygon.py utils.py idlbreakline.py
EXTRAS = metadata.txt
