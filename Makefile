...
PY_FILES = shapeTools.py __init__.py xyToLine.py settings.py geodesicDensify.py geodesicPointDecimate.py geodesicLineDecimate.py geodesicLayerMeasure.py geodesicMeasureTool.py azDigitizer.py lineDigitizer.py geodesicFlip.py provider.py createDonut.py createLob.py createPolygon.py createPie.py createArc.py createStar.py createRose.py createHypocycloid.py createEpicycloid.py createPolyfoil.py createHeart.py utils.py idlbreakline.py createEllipse.py geodesicTransformation.py
EXTRAS = metadata.txt
